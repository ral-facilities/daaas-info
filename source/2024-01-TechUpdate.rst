...
Workspaces
----------
Rocky Linux 8 is avaliable on all workspaces from 5 Feburary 2024. Many thanks for all ISIS instrument scientists who helped on testing the new workspaces since September 2023.

Data
----
ISIS Data cache is the main data source for instrument data from 5 Feb 2024.

The summary of changes and onging works are in section of :doc:`isis-data-cache-2024`.
...
1. DAaaS group will display the number of available workspaces on the workspace claim page.

2. ISIS research group to review workspace specs.
